...
### ANSWER
We say that any observed statistic $X_0^2$ with $\operatorname{df}=1$ greater than
$\chi^2_{0.1}(1) = 2.706$ is not compatible with the null model at significance
level $\alpha = 0.1$.

Since the observed statistic $X_0^2 = 5.939 > 2.706$, the null model, which is
...
We see that $\hat{\pi}_g = 0.782$ and a $90\%$ confidence
interval is $(0.761, 0.802)$.
...
strain is between 0.761 and 0.802.
...
$$
which was computed to be $0.013$. (For comparison, the $p$-value for
the $X^2$ test was $0.015$.)
...
The observed $Z^*$ is 4.402 and its $p$-value is less
...
We see that $G_0^2 = 104.983$ with a $p$-value less than
