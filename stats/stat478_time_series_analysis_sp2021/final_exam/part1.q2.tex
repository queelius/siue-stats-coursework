...
\urlstyle{same}
\hypersetup{
  pdftitle={Time Series Analysis - STAT 478 - Final Exam - Part 1 Q2},
  pdfauthor={Alex Towell (atowell@siue.edu)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Time Series Analysis - STAT 478 - Final Exam - Part 1 Q2}
\author{Alex Towell
...
\hypertarget{part-1-problem-2}{%
\section{Part 1: Problem 2}\label{part-1-problem-2}}
...
Observe that the rate of change of the bias as a function of \(\theta\)
is given by \[
   \frac{\partial \bias}{\partial \theta} = \frac{1}{(1-\theta)^2}
\] and thus as \(\theta\) moves away from \(0.5\) the bias increases
without bound as it approaches \(1\) or \(0\), with the exception that
when \(\theta = 0\) the bias is \(0\).
