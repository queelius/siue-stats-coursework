...
![](exam1_files/figure-latex/unnamed-chunk-2-1.pdf)<!-- --> 
...
![](exam1_files/figure-latex/unnamed-chunk-3-1.pdf)<!-- --> 
...
We see that an estimate of standard error of the MLE is $\operatorname{sd}(\hat{\theta}_{\rm{mle}}) = 0.0514673$.
