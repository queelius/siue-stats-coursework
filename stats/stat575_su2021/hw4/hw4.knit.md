...
![](hw4_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
![](hw4_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](hw4_files/figure-latex/unnamed-chunk-8-1.pdf)<!-- --> 
...
|                     |     mean|
|:--------------------|--------:|
|acceptance-rejection | 8.801601|
|metropolis-hastings  | 8.644574|
...
![](hw4_files/figure-latex/unnamed-chunk-13-1.pdf)<!-- --> 
...
|                            |        mu|
|:---------------------------|---------:|
|independence chain          | 0.6805662|
|random walk                 | 0.6739220|
|reparameterized random walk | 0.6752220|
...
![](hw4_files/figure-latex/unnamed-chunk-19-1.pdf)<!-- --> 
...
![](hw4_files/figure-latex/unnamed-chunk-20-1.pdf)<!-- --> 
...
![](hw4_files/figure-latex/unnamed-chunk-21-1.pdf)<!-- --> 
...
We estimate $(\mu,\tau)$ to be $(4.9249, 0.2232)'$.
Therefore, we estimate that the data is being sampled from the normal
distribution
\begin{equation}
  X_i \sim N(\mu=4.9249,\sigma^2=4.4803).
\end{equation}
...
![](hw4_files/figure-latex/unnamed-chunk-25-1.pdf)<!-- --> 
...
![](hw4_files/figure-latex/unnamed-chunk-25-2.pdf)<!-- --> 
