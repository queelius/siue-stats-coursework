...
![](c_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
![](c_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](c_files/figure-latex/unnamed-chunk-8-1.pdf)<!-- --> 
...
|                     |     mean|
|:--------------------|--------:|
|acceptance-rejection | 8.644872|
|metropolis-hastings  | 9.021872|
...
![](c_files/figure-latex/unnamed-chunk-13-1.pdf)<!-- --> 
...
|                            |        mu|
|:---------------------------|---------:|
|independence chain          | 0.6904040|
|random walk                 | 0.7004426|
|reparameterized random walk | 0.6902331|
...
![](c_files/figure-latex/unnamed-chunk-19-1.pdf)<!-- --> 
...
![](c_files/figure-latex/unnamed-chunk-20-1.pdf)<!-- --> 
...
![](c_files/figure-latex/unnamed-chunk-21-1.pdf)<!-- --> 
...
We estimate $(\mu,\tau)$ to be $(4.9241, 0.2579)'$.
Therefore, we estimate that the data is being sampled from the normal
distribution
\begin{equation}
  X_i \sim N(\mu=4.9241,\sigma^2=3.8775).
\end{equation}
...
![](c_files/figure-latex/unnamed-chunk-25-1.pdf)<!-- --> 
...
![](c_files/figure-latex/unnamed-chunk-25-2.pdf)<!-- --> 
